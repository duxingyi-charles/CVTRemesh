...
//        T gx_min(unsigned axis) const { return (axis==0)?x_min_:y_min_; }
//        T gx_max(unsigned axis) const { return (axis==0)?x_max_:y_max_; }
...
//_________________________________________________________________________
 ...
 //       T gx_min(unsigned axis) const { return (axis==0)?x_min_:((axis==1)?y_min_:z_min_); }
//        T gx_max(unsigned axis) const { return (axis==0)?x_max_:((axis==1)?y_max_:z_max_); }
        T width()  const { return x_max() - x_min() ; }
        T height() const { return y_max() - y_min() ; }
