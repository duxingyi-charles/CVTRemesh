...
//_________________________________________________________
    ...
    namespace MapCombels {
        ...
        public:
			...
			//dxy add
			bool is_sharp(double dihedral_dot) const ;
			bool is_corner(double dihedral_dot) const;
			//
		...
		//dxy 
		inline bool Halfedge::is_sharp(double dihedral_dot) const {
			if (is_border_edge()) return true;

			vec3 n1 = facet()->normal();
			vec3 n2 = opposite()->facet()->normal();
			double d = dot(n1, n2);
			if (d != d) //NAN 
			{
				return true;
